  ...
  <div>
    ...
    <v-layout row>
      ...
      <v-flex xs6 offset-xs3>
        <v-select append-icon="event" outline class=" primary--text" :items="listDate" v-model="activeDate" single-line menu-props="auto" hide-details @input="getDeliveries()"></v-select>
      </v-flex>
    </v-layout>
...
export default {
  ...
  methods:{
    ...
    prendreEnCharge(id){
      ...
      axios.post("https://dev-deliverbag.supconception.fr/mobile/drivers/deliveries/edit-status", {
        req
      }, {
        headers: {
